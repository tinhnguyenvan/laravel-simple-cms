        ...
        if (1 == $upload['status']) {
            switch ($params['object_type']) {
                ...
                case Media::OBJECT_TYPE_ADS:
                    ...
                    break;
                case Media::OBJECT_TYPE_CLASSIFIED:
                    $myObject = Classified::query()->find($params['object_id']);
                    break;
                case Media::OBJECT_TYPE_CLASSIFIED_CATEGORY:
                    $myObject = ClassifiedCategory::query()->find($params['object_id']);
                    break;
                case Media::OBJECT_TYPE_MEMBER:
                    $myObject = Member::query()->find($params['object_id']);
                    break;
                case Media::OBJECT_TYPE_SCHOOL:
                    $myObject = College::query()->find($params['object_id']);
                    break;
            }
